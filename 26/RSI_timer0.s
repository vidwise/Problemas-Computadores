...
@;  símbolos 1 o 2 en el vector global simb[], en la posición i_simb,
@;  y actualizar dicha posición;
@;  en caso de final de desactivación del pulsador, debe determinar
@;  el tipo de espacio (códigos 3, 4, 5 o 6) y, para códigos > 3,
@;  notificarlo a través de la variable global nuevo_bloque.
RSI_timer0:
        push {r0-r5, lr}
