...
void main(){
	...
	do {
		...
		swiWaitForVBlank(); //Lo ponemos fuera porque el if casi no realentiza el programa, no tendremos problemas de colisión con el printf.
							//Si no hay pulsacion de teclas, se disminuirá el consumo de la CPU.
