...
unsigned char
unsigned char
//valores de los LEDs, en cada posición:
//
= 0 → vacía (apagado)
//
...
fil = 1, col = 4;
// fila y columna de la ficha que
// se está colocando
fase = 0;
...
= 3 → final de partida
f_refresco = 0;
// índice de fila que se tiene
// que refrescar en el display
void main()
{
int keys;
inicializaciones();
// la matriz estará toda a ceros,
matriz[0][col-1] = turno;
// excepto la posición de salida
do
{ swiWaitForVBlank();
// relajar bucle principal
switch (fase)
{
case 0:
